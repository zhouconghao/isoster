...
- **Geometry damping**: `geometry_damping` (0-1, default 1.0) scales geometry corrections to prevent oscillations. Values like 0.7 help when fits oscillate without converging.
...
- **Oscillating fits**: Use `geometry_damping=0.5-0.7` to stabilize geometry updates that oscillate without converging
