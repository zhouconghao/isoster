...
INVENTORY_COLUMNS: tuple[str, ...] = (
    ...
    "abs_resid_over_ref_mid",
    "abs_resid_over_ref_outer",
    "abs_resid_over_sigma_inner",
    "abs_resid_over_sigma_mid",
    "abs_resid_over_sigma_outer",
    "azim_A1_inner",
    "azim_A1_mid",
    "azim_A1_outer",
    "azim_A2_inner",
    ...
    "azim_struct_ratio_mid",
    "azim_struct_ratio_outer",
    "azim_phase1_deg_inner",
    "azim_phase1_deg_mid",
    "azim_phase1_deg_outer",
    "quadrant_imbalance_inner",
    "quadrant_imbalance_mid",
    "quadrant_imbalance_outer",
    "image_sigma_adu",
    "sigma_method",
    "n_iso_ref_used",
    "flags",
